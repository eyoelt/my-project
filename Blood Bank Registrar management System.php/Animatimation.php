<!--Start The animation code here-->
	...
	/*responsive code end*/
			...
			color:#ffffff;line-height:30px;text-align:center;">Debremarkos blood bank Services</div>
			</div>
			<div>
			...
			font-size:20px;color:#ffffff;line-height:30px;text-align:center;">Give Blood and Save Life</div>
			</div>
			<div>
			...
			background-color:rgba(235,81,0,0.5);font-size:20px;
			color:#ffffff;line-height:30px;text-align:center;">Donate and Recive Blood</div>
			</div>
			<div>
			...
			color:#ffffff;line-height:30px;text-align:center;">Blood donors Donate blood</div>
			</div>
			<div>
			...
			background-color:rgba(235,81,0,0.5);font-size:20px;
			color:#ffffff;line-height:30px;text-align:center;">Blood Stored in stocks</div>
			</div>
			<div>
			...
			font-size:20px;color:#ffffff;line-height:30px;text-align:center;">By giving blood You can Get Satisfaction</div>
			</div>
			<div data-b="0">
			...
			font-size:20px;color:#ffffff;line-height:30px;text-align:center;">You can make Appointment oline</div>
			</div>
			<div data-b="0">
			<img data-u="image" src="Images/BloodImage_15.jpg" />
			<div data-u="caption" data-t="7" style="position:absolute;top:-50px;
			left:30px;width:350px;height:30px;z-index:0;background-color:rgba(235,81,0,0.5);
			font-size:20px;color:#ffffff;line-height:30px;text-align:center;">You Can Know your Blood Types</div>
			</div>
