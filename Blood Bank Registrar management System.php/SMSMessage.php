  ...
  <body>
   <div id="container">
    ...
    <form action="" method="post">
     <ul>
      <li>
       <label for="phoneNumber">Sender</label>
       <input type="text" name="phoneNumber" id="phoneNumber" placeholder="+251945879856" /></li>
      <li>
      <label for="carrier">Reciever</label>
       <input type="text" name="carrier" id="carrier"placeholder="+251945879856" />
      </li>
      <li>
