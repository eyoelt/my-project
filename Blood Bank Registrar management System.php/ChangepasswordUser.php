...
<tr><td colspan="2"><h2 style="font-size:25px;text-align: center;">Change Your Password 
 <div style="float:right; margin-left:40px;"><a href="LoginPage.php" title="Close"><img src="Images/close.jpg"></a></div></h2><br><br></td></tr>
...
<tr><td><font color="red">*</font> Old Password:</td><td><input type="password" name="olpw" placeholder="Enter your old passwoerd" required></td></tr>
...
$cpw=$_POST['confermp'];
if(strlen($npsw)<=5)
echo "Your Password  Length Must be Greater Than 8";
